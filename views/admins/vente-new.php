...
<div class="d-xl-flex align-items-center justify-content-between mt-3 mb-4">
    <h1 class="h3 mb-0 text-gray-800"> Ajouter à vendre </h1> 
    <form id="search_p" class="h4 text-primary font-weight-bolder" method="post">
        <?php 
            echo $db_Admins->numberocur('maison_achat')->count." en vente";
        ?>
    </form>
</div>


    <p class="text-center text-primary font-weight-bold h4">Formulaire d'ajout de bien immobilier en vente</p> <br>
...
<form method="post" id="add_vente_immo">
  ...
  <button id="add" class="btn btn-outline-primary font-weight-bold mb-5" >Ajouter <i class="fa fa-plus"></i></button>
</div>
