...
if(Http::methods("POST")){
    ...
    $insert_2='INSERT INTO  maison_achat(piscine,jardin,id_article,type_log) VALUES(:piscine,:jardin,:id_article,:type_log)'; 
    ...
    $resp_2 = $db_Immo->del_immo("maison_achat",$data['id_article']);
    ...
    $updt_2='UPDATE maison_achat SET piscine = :piscine, jardin = :jardin, type_log = :type_log WHERE id_article = :id_article'; 
